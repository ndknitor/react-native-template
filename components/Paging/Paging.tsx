...
import { range } from '../../libs/functions';
            ...
            <View style={{
                ...
                <TouchableOpacity
                    ...
                    style={{
                        ...
                        backgroundColor: colors.primary.tint3,
                        width: 30,
                        height: 30,
                        borderRadius: 9999,
                        alignItems: "center",
...
function ThreeDot(props: { display: boolean }) {
    return (
        <View style={{
            ...
            <View style={{ backgroundColor: colors.primary.main, width: 3, height: 3, borderRadius: 9999, marginRight: 2 }} />
            <View style={{ backgroundColor: colors.primary.main, width: 3, height: 3, borderRadius: 9999, marginRight: 2 }} />
            <View style={{ backgroundColor: colors.primary.main, width: 3, height: 3, borderRadius: 9999, marginRight: 2 }} />
        </View>
    )
